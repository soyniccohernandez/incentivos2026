...
<head>
    ...
    <style>
        ...
        .status-pill { display: inline-block; padding: 4px 10px; border-radius: 4px; font-size: 10px; font-weight: bold; text-transform: uppercase; }
...
<body>
    <div class="report-container">
        ...
        <div class="content">
            ...
            <table>
                <tr>
                    ...
                    <td class="value"><strong style="font-size: 16px; color: #ff6600;">{{ mb_strtoupper($proyecto->titulo) }}</strong></td>
                </tr>
                <tr>
                    ...
                    <td class="value">
                        ...
                        @else
                            <span class="status-pill pill-orange">CESIÓN DE DERECHOS (ANEXO 3 INCLUIDO)</span>
                        @endif
                    </td>
                </tr>
            </table>
            ...
            <table>
                ...
                <tr><td class="label">Correo Electrónico:</td><td class="value" style="color:#ff6600; font-weight: bold;">{{ $socio->email }}</td></tr>
            </table>

            <div class="section-header">3. PERFIL DEL DIRECTOR</div>
            <table>
                <tr>
                    <td class="label">Vínculo con Socio:</td>
                    <td class="value">
                        @if($config['directorPropio'] === 'si') 
                            <span class="status-pill pill-dark">SÍ, EL SOCIO ES EL DIRECTOR</span>
                        @else 
                            <span class="status-pill pill-orange">NO, DIRECTOR EXTERNO REGISTRADO</span>
                        @endif
                    </td>
                </tr>
                {{-- Solo mostrar datos si el director es un tercero --}}
                @if($config['directorPropio'] === 'no')
            ...
            <div class="section-header">4. LISTADO DE ARCHIVOS ADJUNTOS</div>
            <p style="font-size: 11px; color: #888; margin-bottom: 10px;">El sistema ha adjuntado los siguientes documentos para su revisión técnica:</p>
            <table>
                @foreach($documentos as $doc)
                @if(!($doc->tipo_documento_id == 1 && $config['autoria'] === 'si'))
                <tr>
                    <td class="label" style="font-size: 9px; vertical-align: middle;">DOCUMENTO:</td>
                    <td class="value" style="font-family: monospace; font-size: 12px; border-left: 3px solid #ff6600; padding-left: 10px; background: #fafafa;">
        ...
        <div class="footer">
            ACTORES S.C.G. | SOCIEDAD COLOMBIANA DE GESTIÓN © 2026<br>
            <span style="font-size: 8px; opacity: 0.6;">ESTE REPORTE TIENE VALIDEZ LEGAL PARA EL PROCESO DE AUDITORÍA</span>
        </div>
    </div>
</body>
</html>