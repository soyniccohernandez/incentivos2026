<div class="min-h-screen py-8" wire:poll.15s>
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                    ...
                    {{ $totalPendientes > 0 ? 'bg-[#ff6600] hover:bg-[#e65c00]' : 'bg-emerald-600 cursor-not-allowed opacity-60' }}">
                    
                    <div wire:loading wire:target="publicarResultados">
                        <svg class="animate-spin h-4 w-4 text-white mr-2" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            <div class="bg-white shadow-sm border border-gray-100 rounded-2xl p-5">
                <div class="flex items-center">
                    <div class="p-3 rounded-xl bg-indigo-50 text-indigo-600"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div>
                    <div class="ml-4">
            ...
            <div class="bg-white shadow-sm border border-gray-100 rounded-2xl p-5">
                <div class="flex items-center">
                    <div class="p-3 rounded-xl bg-amber-50 text-amber-600"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div>
                    <div class="ml-4">
            ...
            <div class="bg-white shadow-sm border border-gray-100 rounded-2xl p-5">
                <div class="flex items-center">
                    <div class="p-3 rounded-xl bg-green-50 text-green-600"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div>
                    <div class="ml-4">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-indigo-50/30 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    {{-- Avatar usando tu lógica de Socio.php --}}
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex flex-col items-center gap-1">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm
                                        {{ $proyecto->estado->es_final ? 'bg-emerald-100 text-emerald-700' : 'bg-indigo-50 text-indigo-700' }}">
                        ...
                        @empty
                            <tr><td colspan="5" class="p-10 text-center text-gray-400 italic">No se encontraron proyectos.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
