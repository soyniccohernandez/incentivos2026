<div class="min-h-screen bg-black flex flex-col items-center justify-center p-6 relative overflow-hidden"> 
    ...
    <div class="max-w-[560px] w-full z-10"> 
        <header class="mb-10 text-center"> 
            <a href="/" class="font-bebas text-4xl text-brand-orange tracking-[3px] no-underline inline-block mb-2 uppercase"> ACTORES S.C.G. </a> 
            <div class="text-brand-orange/60 font-bold text-[10px] uppercase tracking-[4px]"> Convocatoria Incentivos 2026 </div> 
        </header> 
            ...
            <div class="relative z-10"> 
                <header class="mb-8 border-l-4 border-brand-orange pl-6 text-left"> 
                    <h1 class="font-bebas text-4xl md:text-5xl leading-none text-white mb-2 uppercase">
                        @if($paso == 'identificar') ACCESO A <br> <span class="text-brand-orange">INSCRIPCIÓN</span>
                        @elseif($paso == 'registrar') CREAR <br> <span class="text-brand-orange">CONTRASEÑA</span>
                        @else BIENVENIDO <br> <span class="text-brand-orange">DE NUEVO</span> @endif
                    </h1> 
                    <p class="text-gray-400 text-sm leading-relaxed uppercase tracking-wider">
                        @if($paso == 'identificar') Verifica tu estado de socio para continuar 
                        @elseif($paso == 'registrar') Hola {{ $nombreSocio }}, protege tu cuenta
                        @else Hola {{ $nombreSocio }}, ingresa para continuar @endif
                    </p> 
                </header> 

                <form wire:submit.prevent="validar" class="space-y-6"> 
                    <div class="group/item"> 
                        <label class="block text-[10px] uppercase font-bold text-gray-500 mb-3 tracking-widest group-hover/item:text-brand-orange transition-colors"> Número de Identificación </label> 
        ...
        <div class="mt-8 text-center"> 
            <a href="/" class="text-gray-500 text-[10px] uppercase font-bold tracking-[2px] hover:text-brand-orange transition-colors no-underline"> ← Volver al inicio </a> 
        </div> 
    </div> 
</div>